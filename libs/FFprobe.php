...
class FFprobe implements \JsonSerializable {
    ...
    const QUERY_CMD = "/usr/local/bin/ffprobe -i %s -v quiet -print_format json -show_format";
    ...
    public static function read($filename) {
        ...
        $command = sprintf("%s -i %s -v quiet -print_format json -show_format", Config::getSetting("General", "ffprobe_cmd"), $escapedFilename);
